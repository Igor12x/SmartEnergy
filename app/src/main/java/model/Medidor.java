...
public class Medidor extends Progressbar{
    ...
    public static void buscarConsumoAtual(int id, RequestQueue solicitacao, BuscaConsumoListener listener){
        String url = "http://10.0.2.2:5000/api/Medidor/BuscarConsumo/59";
    ...
    public static void buscarConsumoDiario(int id, RequestQueue solicitacao, BuscaConsumoDiarioListener listener){
        String url = "http://10.0.2.2:5000/api/Medidor/BuscarConsumoDiario/1";
        ...
        JsonArrayRequest envio = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    JSONObject object = response.getJSONObject(0);
                    //chamando método onResultado como callback
                    listener.onResultado(object.getDouble("consumo2"));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
